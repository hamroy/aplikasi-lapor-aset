        ...
        <div class="container">
            <div class="row ilham">
             <div class="col-lg-9 col-md-9 col-md-offset-2 col-sm-offset-2 col-sm-9 col-xs-12 u">
                   ...
                   <div class="ilham12">
    <div class="well"><span class="judul">PALIDASI</span></div>
    <form method="post" action="<?=base_url('login/daftar_simpan/')?>">
        <div class="form-group">
            <ul class="list-group">
               
                 <li class="list-group-item">
                    <input type="text" name="no" required placeholder="No Rahasia" class="form-control ilhams" style="background-color:rgb(255,255,255);width:50%;" />
                    <small class="text-info">No. Dikirim Via Email.</small>
                </li>
                
                <li class="list-group-item">
                    <button class="btn btn-default btn-block btn-lg ilham" data-aos="zoom-down" type="submit"><strong>Lanjut</strong> </button>
                </li>
            </ul>
        </div>
    </form>
